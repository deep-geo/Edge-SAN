...
def parse_train_args():
    ...
    parser.add_argument("--unsupervised_pred_iou_thresh", type=float, default=0.88, help="Mask filtering threshold in [0,1]")
    parser.add_argument("--unsupervised_stability_score_thresh", type=float, default=0.95, help="Mask filtering threshold in [0,1]")
